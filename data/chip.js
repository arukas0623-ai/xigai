...
window.XIGAI["半导体与芯片"] = [
  {
    ...
    "applications": ["7nm以下逻辑芯片制造", "先进制程晶圆代工产线"],
    "misconceptions": [
      "EUV光刻机并非单一机器，而是光源、光学、真空等庞大系统集成",
      "国产EUV尚未量产，国产光刻主流仍是DUV浸没式"
    ],
    "related": ["先进制程", "光刻机", "晶圆代工"],
    "references": [
  ...
  },
  {
    "id": "advanced-node",
    "name": "先进制程",
    "aliases": ["先进工艺", "Advanced Node", "亚10nm制程"],
    "field": "半导体与芯片",
    "tags": ["制程工艺", "晶圆制造"],
    "difficulty": 3,
    ...
    "applications": ["智能手机旗舰SoC", "AI加速器与服务器CPU", "消费电子高性能芯片"],
    "misconceptions": [
      "“2nm”并非物理栅极长度，而是等效工艺命名",
      "良率爬坡节奏决定实际量产进度"
    ],
    "related": ["EUV光刻", "晶圆代工", "AI芯片"],
    "references": [
  ...
  },
  {
    ...
    "applications": ["AI加速卡与数据中心CPU/GPU", "高性能计算系统", "异构SoC设计"],
    "misconceptions": [
      "Chiplet不是简单“拼接”，需要统一互连协议与协同设计",
      "Chiplet不等于所有芯片都更便宜"
    ],
    "related": ["先进封装", "AI芯片", "先进制程"],
    "references": [
  ...
  },
  {
    ...
    "name": "先进封装",
    "aliases": ["Advanced Packaging", "2.5D/3D封装", "CoWoS"],
    "field": "半导体与芯片",
    "tags": ["封装测试", "异构集成"],
    "difficulty": 3,
    ...
    "applications": ["AI GPU与HBM集成", "高性能计算", "手机SoC封装"],
    "misconceptions": [
      "先进封装不能替代先进制程，但可显著弥补制程差距",
      "CoWoS只是先进封装的一种，并非全部"
    ],
    "related": ["Chiplet小芯片", "HBM高带宽内存", "AI芯片"],
    "references": [
      "长电科技78亿投资先进封装",
  ...
  },
  {
    "id": "hbm",
    "name": "HBM高带宽内存",
    "aliases": ["HBM", "高带宽存储器", "High Bandwidth Memory"],
    "field": "半导体与芯片",
    "tags": ["存储芯片", "AI算力"],
    "difficulty": 3,
    ...
    "applications": ["AI训练/推理加速卡", "超级计算机", "数据中心服务器"],
    "misconceptions": [
      "HBM价格昂贵且产能集中，并非所有服务器都适用",
      "HBM4E是HBM4的增强版本而非换代产品"
    ],
    "related": ["存储芯片", "AI芯片", "先进封装"],
    "references": [
      "三星HBM4量产四月销售额破10亿美元",
  ...
  },
  {
    "id": "risc-v",
    "name": "RISC-V",
    "aliases": ["RISC-V架构", "开源指令集", "开源处理器架构"],
    "field": "半导体与芯片",
    "tags": ["处理器架构", "开源生态"],
    "difficulty": 3,
    ...
    "applications": ["物联网与嵌入式MCU", "汽车电子", "AI推理与服务器芯片"],
    "misconceptions": [
      "RISC-V“免费”指指令集免费，芯片设计仍需大量投入",
      "RISC-V并非天生更省电，功耗取决于具体实现"
    ],
    "related": ["AI芯片", "汽车芯片", "NPU"],
    "references": [
  ...
  },
  {
    ...
    "applications": ["新能源汽车", "光伏与储能", "快充与数据中心电源"],
    "misconceptions": [
      "第三代半导体不会完全取代硅，而是互补共存",
      "“第三代”指材料代际，并非性能全面碾压"
    ],
    "related": ["碳化硅", "氮化镓", "汽车芯片"],
    "references": [
  ...
  },
  {
    ...
    "applications": ["新能源车主驱逆变器", "光伏逆变器", "充电桩与储能"],
    "misconceptions": [
      "SiC并非只用于汽车，工业电源与光伏同样是重要场景",
      "SiC成本高于硅，需在系统层面体现收益"
    ],
    "related": ["第三代半导体", "氮化镓", "汽车芯片"],
    "references": [
  ...
  },
  {
    ...
    "applications": ["手机/笔记本快充", "服务器与数据中心电源", "电动汽车车载充电"],
    "misconceptions": [
      "GaN与SiC同属第三代半导体但侧重不同：GaN偏高频中小功率，SiC偏高压大功率"
    ],
    "related": ["第三代半导体", "碳化硅", "汽车芯片"],
    "references": [
  ...
  },
  {
    ...
    "applications": ["大模型训练与推理", "智算中心", "端侧AI"],
    "misconceptions": [
      "AI芯片不只是GPU，NPU与ASIC在推理场景可能更高效",
      "算力数值不等于实际性能，软件生态同样关键"
    ],
    "related": ["NPU", "HBM高带宽内存", "先进封装"],
    "references": [
  ...
  },
  {
    "id": "npu",
    "name": "NPU",
    "aliases": ["神经网络处理器", "Neural Processing Unit"],
    "field": "半导体与芯片",
    "tags": ["端侧AI", "处理器"],
    "difficulty": 2,
    ...
    "applications": ["AI PC与智能手机", "智能驾驶座舱", "端侧大模型部署"],
    "misconceptions": [
      "NPU的TOPS数值高不等于体验好，需结合内存带宽与软件优化",
      "NPU不会取代GPU，两者定位不同"
    ],
    "related": ["AI芯片", "RISC-V", "汽车芯片"],
    "references": [
  ...
  },
  {
    ...
    "applications": ["全球逻辑芯片制造", "先进制程量产", "功率/模拟特种工艺"],
    "misconceptions": [
      "代工厂不设计芯片，但提供设计规则与PDK协同设计",
      "“代工”并非低端制造，先进制程代工是顶级技术活"
    ],
    "related": ["先进制程", "EUV光刻", "光刻机"],
    "references": [
  ...
  },
  {
    ...
    "name": "光刻机",
    "aliases": ["光刻设备", "Lithography Equipment"],
    "field": "半导体与芯片",
    "tags": ["半导体设备", "制造设备"],
    "difficulty": 3,
    ...
    "applications": ["晶圆制造前道光刻", "先进制程与成熟制程产线"],
    "misconceptions": [
      "光刻机厂商不止ASML一家，但EUV仅ASML能量产",
      "国产突破28nm不等于突破EUV"
    ],
    "related": ["EUV光刻", "晶圆代工", "先进制程"],
    "references": [
      "国产光刻机SSA800实现批量交付",
  ...
  },
  {
    ...
    "applications": ["服务器与PC内存", "手机与SSD存储", "AI加速器HBM"],
    "misconceptions": [
      "存储涨价不等于全行业普涨，HBM与利基存储走势分化",
      "“超级周期”存在不确定性，需关注供给端恢复"
    ],
    "related": ["HBM高带宽内存", "AI芯片", "晶圆代工"],
    "references": [
  ...
  },
  {
    ...
    "applications": ["智能驾驶域控制器", "智能座舱SoC", "三电系统功率器件"],
    "misconceptions": [
      "车规认证周期长、要求严，“上车”不等于“放量”",
      "国产替代在MCU/功率领域较快，高端智驾SoC仍有差距"
    ],
    "related": ["碳化硅", "RISC-V", "NPU"],
    "references": [
      "国产汽车芯片企业晒出“量产成绩单”",
      "被涨价惊醒的车企：自研芯片是一场自卫战"
    ],
