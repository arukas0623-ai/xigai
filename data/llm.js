...
window.XIGAI["大模型横评"] = [
  {
    ...
    "principle": "DeepSeek-V4 的工作方式基于混合专家（MoE）架构，通过动态分配计算资源来优化性能和效率。该模型系列采用先进的训练算法和技术，能够在保持高性价比的同时显著提升数学推理、代码生成与长文本理解的能力。Flash 版本利用轻量级设计实现低延迟，而 Pro 版本则提供更强的算力支持以应对复杂任务。",
    "pros": [
      "高性能：在数学推理、代码生成和长文本理解方面有显著提升",
      "高性价比：保持极低的使用价格",
      "开源友好：作为旗舰开源大模型系列，易于社区贡献与改进"
    ],
    "cons": [
      "算力限制：Pro 版本虽然更强，但可能仍需依赖高性能计算资源"
    ],
    "confidence": 0.9,
    "status": "verified"
  },
